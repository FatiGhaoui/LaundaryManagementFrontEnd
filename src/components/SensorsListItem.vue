  ...
  <div class="sensor border border-secondary rounded p-2 mb-2" :class="{ expanded: isExpanded }">
    ...
    <template v-if="isExpanded">
      ...
      <div class="details d-flex">
        <button type="button" class="btn btn-primary me-2" @click="switchSensor">{{ isSensorWorking ? 'Not' : ''
        }}Working</button>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <button type="button" class="btn btn-danger" @click="deleteSensor">Delete</button>
            </div>
          </div>
        </div>
      </div>
